...
const NorseApp = function(){
  this.request1 = new Request('http://localhost:3000/api/gods');
  this.request2 = new Request('http://localhost:3000/api/vikings');
  this.request3 = new Request('http://localhost:3000/api/valhalla');
  this.request4 = new Request('http://localhost:3000/api/stories');
};
